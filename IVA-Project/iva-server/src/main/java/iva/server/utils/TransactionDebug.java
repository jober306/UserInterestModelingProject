package iva.server.utils;

import java.lang.reflect.InvocationTargetException;

//Copied from http://blog.timmattison.com/archives/2012/04/19/tips-for-debugging-springs-transactional-annotation/
public class TransactionDebug {
	public static boolean transactionDebugging = false;
	public static boolean verboseTransactionDebugging = false;
